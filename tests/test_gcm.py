...
from pushjack import GCMClient, GCMError, exceptions
...
@parametrize(
    "tokens,data,extra,message",
    [
        (
            "abc",
            "Hello world",
            {},
            {"to": "abc", "data": {"message": "Hello world"}, "priority": "high"},
        ),
        (
            "abc",
            "Hello world",
            {"low_priority": True},
            {"to": "abc", "data": {"message": "Hello world"}},
        ),
        (
            "abc",
            {"message": "Hello world"},
        ...
        assert res.data == [
            {
                ...
                "failure": 0,
                "canonical_ids": 0,
                "results": [{"message_id": token} for token in tokens],
            }
        ]
...
@parametrize(
    "tokens,status_code,results,expected",
    [
        (
            [1, 2, 3, 4, 5],
            200,
            ...
            ],
            {
                ...
                "errors": [
                    (exceptions.GCMMissingRegistrationError, 1),
        ...
        (
            ...
            [],
            {
                "registration_ids": [1, 2, 3, 4, 5],
                "errors": [
                    (exceptions.GCMInternalServerError, 1),
...
@parametrize(
    "tokens,data,extra,auth,expected",
    [
        (
            "abc",
            {},
